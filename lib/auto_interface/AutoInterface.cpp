...
void AutoInterface::loop() {
    ...
    if (now - _last_announce >= ANNOUNCE_INTERVAL) {
        ...
        // Hybrid 2026-07-22: lowered again to 4KB. The launcher build's
        // steady-state largest block sits near 8KB by design (internal
        // is budgeted tightly; see HYBRID_PLAN D11) and the announce
        // genuinely needs well under 1KB — at 8000 this guard was
        // silently making the device invisible to peers.
