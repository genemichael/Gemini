# Gemini 
is based on a highly-modified fork of MeshPunk, and utilizes Torlando’s [highly modified fork](https://github.com/torlando-tech/microReticulum/tree/feat/t-deck) of [microReticulum](https://github.com/attermann/microReticulum) as a service. 
